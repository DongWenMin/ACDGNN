...
def parse_args():
    ...
    parser.add_argument("--test_file", "-ttf", type=str, default="test",
                        help="Name of file containing validation triplets")
    parser.add_argument("--split", "-s", type=str, default="inductive1/data_1",
    ...
    parser.add_argument("-dsf", type=int, choices=[0,1], default=1, 
                        help='whether using generated ddi structure feature')
